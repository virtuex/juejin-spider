...
r = requests.post('https://api.juejin.cn/booklet_api/v1/booklet/get?aid=2608&uuid=7002432548753049092&spider=0',
...
for section in sections:
    ...
    rsp = requests.post('https://api.juejin.cn/booklet_api/v1/section/get?aid=2608&uuid=7002432548753049092&spider=0',
